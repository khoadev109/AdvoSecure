...
import { BillingGroup } from '../models/billing-group.model';
...
export class CommonService {
  ...
  getBillingGroups() : Observable<BillingGroup[]> {
    return this.httpClient.get<BillingGroup[]>(this.API_COMMON_URL + "/billing-groups");
  }
