...
namespace AdvoSecure.Api.Authentication
{
    public class RsaResolver
    {
        ...
        public RsaResolver()
        {
            ...
            string privateKey = Path.Combine(projectPath, @"Authentication\keys\advopwd.pem");
            string publicPem = Path.Combine(projectPath, @"Authentication\keys\advopwd-pub.pem");
