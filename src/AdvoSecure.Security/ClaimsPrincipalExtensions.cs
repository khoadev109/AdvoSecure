...
namespace AdvoSecure.Security
{
    public static class ClaimsPrincipalExtensions
    {
        ...
        {
            return (int)Convert.ChangeType(principal.FindFirstValue(AdvoClaimTypes.UserIdClaimType, true), typeof(int));
        }

        public static int GetSurveyTenantIdValue(this ClaimsPrincipal principal)
        {
            return (int)Convert.ChangeType(principal.FindFirstValue(AdvoClaimTypes.TenantIdClaimType, true), typeof(int));
        }
