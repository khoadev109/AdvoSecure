...
namespace AdvoSecure.Security
{
    public class JwtResolver
    {
        ...
        public string GenerateAccessToken(UserClaims userClaims)
        {
            ...
            {
                new (ClaimConstants.UserIdentifier, userClaims.UserIdentifier),
                new (ClaimConstants.TenantAdminIdentifier, userClaims.TenantAdminIdentifier),
            ...
            {
                claims.Add(new(ClaimConstants.TenantIdentifier, userClaims.TenantIdentifier));
            }
